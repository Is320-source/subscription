            ...
            dias_semana: dias_semana, mensalidade: mensalidade, valor: valor
					...
					success: function(dado){
						if(dado.toString() === "success"){
							jQuery("#info-alert").html("<div class='alert alert-primary alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>                  <h5><i class='icon fas fa-check'></i> SUCESSO!</h5> Inscrição feita com sucesso... </div>").show(200).delay(4000).hide(200);                       
						    
							return false; 
						} 
						if(dado.toString() === "error"){ 
							jQuery("#info-alert").html("<div class='alert alert-warning alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h5><i class='icon fas fa-exclamation-triangle'></i> Atenção!</h5>dados inválidos!</div>").show(200).delay(5000).hide(200);
								return false;
						}
					},
					error: function(erro){
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Ficha de Inscrição</h1>
                <h3 class="h4 text-gray-900 mb-4">Informações Pessoais</h3>
              </div>
              <form class="user">
                ...
                <div class="form-group ">
                  ...
                  <div class="form-group">
                    <input type="text" style=" border-radius: 3px;" class="form-control form-control-user border-bottom-success" id="passaport" placeholder="Passaporte Nº">
                  </div>
                </div>
                <div class="form-group ">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" style=" border-radius: 3px;" class="form-control form-control-user border-bottom-success" id="habilitacao" placeholder="Habilitação Literária">
                  </div>
                </div>
                <div class="form-group ">
                  <div class="form-group">
                    <input type="text" style=" border-radius: 3px;" class="form-control form-control-user border-bottom-success" id="profissao" placeholder="Profissão">
                  </div>
                </div>
                <h3 class="h4 text-gray-900 mb-4"> Curso de Formação em que se Escreve </h3>
                <div class="form-group">
                  <div class="form-group">
